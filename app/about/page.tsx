        ...
        >
          ...
          <motion.div variants={itemVariants} className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
              {['React', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Node.js', 'PostgreSQL', 'Prisma'].map((skill) => (
                <span key={skill} className="inline-flex items-center rounded-md bg-secondary px-3 py-1 text-sm font-medium text-secondary-foreground">
                  {skill}
                </span>
              ))}
            </div>
