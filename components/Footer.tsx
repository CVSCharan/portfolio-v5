      ...
      <div className="max-w-6xl mx-auto px-5 md:px-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[1.5fr_1fr_1fr_1fr] gap-12 mb-20">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-3 text-sm text-muted-foreground font-medium">
              <a href="https://github.com/CVSCharan/portfolio-v5" target="_blank" rel="noopener noreferrer" className="hover:text-foreground transition-colors w-fit">Source Code</a>
              <Link href="/admin" className="hover:text-foreground transition-colors w-fit">Admin Dashboard</Link>
            </div>
          </div>
