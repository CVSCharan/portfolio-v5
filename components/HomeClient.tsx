      ...
      : [
          {
            ...
            slug: "antigravity-ai",
            description:
              "A highly interactive, fluid 3D portfolio powered by React Three Fiber, Next.js, and Prisma 8.",
            imageUrl: null,
          },
          {
            id: -2,
            ...
            slug: "data-analytics",
            description:
              "Scalable data ingestion and visualization platform built with AWS, PostgreSQL, and Python.",
            imageUrl: null,
          },
        ];
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto px-5 md:px-0 flex flex-col justify-center pointer-events-none h-full gap-10 md:gap-16 pt-24 md:pt-32 pb-16 md:pb-24">
          ...
          >
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-bricolage)" }}
            >
              Building uncompromising digital experiences & intelligent data
              systems.
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="flex flex-wrap items-center justify-start gap-4">
              ...
              <Link
                href="/experience"
                className="text-base font-semibold text-foreground hover:text-secondary transition-colors underline-offset-4 hover:underline"
              >
                View Experience
              </Link>
            </div>
          ...
          >
            <div className="space-y-1.5">
              <p className="text-xs font-bold tracking-[0.15em] uppercase text-muted-foreground/80">
                Core Stack
              </p>
              <p className="text-sm font-medium text-foreground/90 leading-relaxed">
                Next.js, Python, PostgreSQL, Snowflake,
                <br />
                Prisma, LangChain, Tailwind, AWS
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-5 flex flex-col items-start">
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-bricolage)" }}
              >
                From Data Analytics to Full-Stack Engineering, I have built
                AI-driven platforms and cross-platform architecture that scale.
              </p>
              <Link
                href="/experience"
                className="btn btn-outline btn-md group mt-auto"
              >
                Full Experience{" "}
                <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
              </Link>
            ...
            <div className="lg:col-span-7 space-y-4">
              {displayExperiences.map((exp) => (
                <div
                  key={exp.id}
                  className="card p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-4 card-hover shadow-sm backdrop-blur-md bg-card/90"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8">
            ...
            <div className="lg:col-span-5 flex flex-col items-start">
              ...
              <p
                ...
                style={{ fontFamily: "var(--font-bricolage)" }}
              >
                I believe in building uncompromising digital experiences and
                intelligent data systems using modern frameworks and Large
                Language Models.
              </p>
              <Link
                href="/projects"
              ...
              {displayProjects.map((project) => (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col gap-2 z-10">
                    <h3
                      className={`text-xl font-bold flex items-center justify-between ${project.imageUrl ? "text-white" : "text-foreground"}`}
                      style={{ fontFamily: "var(--font-bricolage)" }}
                    >
                      {project.title}
                      <ArrowUpRight
                        className={`w-5 h-5 transition-all group-hover:translate-x-1 group-hover:-translate-y-1 ${project.imageUrl ? "text-white/50 group-hover:text-white" : "text-muted-foreground group-hover:text-foreground"}`}
                      />
                    </h3>
                    {project.description && (
                      <p
                        className={`text-xs line-clamp-2 mt-1 leading-relaxed ${project.imageUrl ? "text-white/80" : "text-muted-foreground"}`}
                      >
                        {project.description}
                      </p>
                    )}
